...
std::string GamepadMapper::button_label(GamepadButtons button, bool use_switch_label) {
    static std::map<GamepadButtons, std::vector<std::string>> map = {
        ...
        { GamepadButtonDown, {"下"} },
        { GamepadButtonLeft, {"左"} },
        { GamepadButtonRight, {"右"} },
        { GamepadButtonPlus, {"开始", "Plus"} },
        { GamepadButtonMinus, {"返回", "Minus"} },
        { GamepadButtonLeftThumb, {"左摇杆"} },
        { GamepadButtonRightThumb, {"右摇杆"} },
        { GamepadButtonL, {"LB", "L"} },
        { GamepadButtonR, {"RB", "R"} },
...
std::string GamepadMapper::combo_label(GamepadCombo combo) {
    static std::map<GamepadCombo, std::string> map = {
        { GamepadComboGuide, "教程" },
        { GamepadComboExit, "退出" },
        { GamepadComboExitAndClose, "退出并关闭" },
        { GamepadComboShowStats, "显示/隐藏状态" },
        { GamepadComboWinKey, "Win 键" },
        { GamepadComboEscape, "ESC 键" },
